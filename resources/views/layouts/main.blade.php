...
<body class="font-mono bg-blue-900 text-white">
  <nav class="border-b border-gray-100">
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
      ...
      <div class="flex flex-col md:flex-row items-center">
        <div class="relative">
          <input type="text" class="bg-gray-700 rounded-full w-70 px-5 py-2 pl-8 focus:outline-none focus:shadow-outline" placeholder="Search">
          <div class="absolute top-0">
            <i class="fa fa-search px-2 py-3 text-gray-400"></i>
          </div>
        </div>
        <div class="ml-5">
          <a href="#">
            <img src="img/myavatar.jpg" alt="User Avatar" class="rounded-full w-11 h-10">
          </a>
        </div>
      </div>
    </div>
